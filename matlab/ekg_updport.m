...
% Aufnahmezeit. Ein Paket entspricht 15 Sekunden Daten.
packets = 2;
...
ekg_data=ekg_data/4095*3.3;                                     % ADC-Werte in Spannung umrechnen
plot(t,ekg_data);
xlabel("Zeit (s)");
ylabel("Spannung (V)");
title("EKG Daten ESP32");
axis([0, 30, 0, 3.3])
save("EKG-Daten_johannes_2.mat","ekg_data");                  % Die gelesenen Daten werden abgespeichert
